...
* 2.7    2024-06-29 Yves Mercier       Add support for events, change fan error handling, remap fan percentage to accomodate for missing named speed.
*/
...
def translateDevices(domain, newVals, friendly, origin)
{
    def mapping =
        [
            ...
            event: [type: "HADB Generic Component Event",               event: [[name: "timestamp", value: newVals[0], descriptionText:"${friendly} event received at ${newVals[0]}"]], namespace: "community"],
