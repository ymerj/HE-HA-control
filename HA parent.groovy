...
def translateSensors(device_class, newVals, friendly, origin)
{
    def mapping =
        [
            ...
            carbon_dioxide: [type: "Generic Component Carbon Dioxide Detector",       event: [[name: "carbonDioxide", value: newVals[0], descriptionText:"${friendly} carbonDioxide is ${newVals[0]}"]]],
