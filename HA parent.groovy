...
def translateSensors(device_class, newVals, friendly, origin)
{
    def mapping =
        [
            ...
            pm25: [type: "Generic Component Pm25",                            event: [[name: "pm25", value: newVals[0], unit: newVals[1], descriptionText:"${friendly} pm2.5 is ${newVals[0]} ${newVals[1]}"]], namespace: "community"],
	]
