...
def translateDevices(domain, newVals, friendly, origin)
{
    def mapping =
        [
            ...
            lock: [type: "Generic Component Lock",                      event: [[name: "lock", value: newVals[0] in ["locked", "unlocked"] ? newVals[0] : "unknown", type: origin, descriptionText:"${friendly} status became ${newVals[0]} [${origin}]"],[name: "rawStatus", value: newVals[0], type: origin, descriptionText:"${friendly} rawStatus became ${newVals[0]} [${origin}]"]]],
