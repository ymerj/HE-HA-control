...
* 2.16   2025-03-05 ritchierich        Add support for gas detector.  - Yves Mercier: Compensate for restrictions imposed by ezdashboard in mediaPlayer and locks, change handling of "off" thermostat mode
*/
...
def translateDevices(domain, newVals, friendly, origin)
{
    def mapping =
        [
            ...
            lock: [type: "HADB Generic Component Lock",                 event: [[name: "lock", value: newVals[0] in ["locked", "unlocked"] ? newVals[0] : "unknown", type: origin, descriptionText:"${friendly} status became ${newVals[0]} [${origin}]"],[name: "rawStatus", value: newVals[0], type: origin, descriptionText:"${friendly} rawStatus became ${newVals[0]} [${origin}]"]]],
