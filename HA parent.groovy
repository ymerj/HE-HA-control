...
def translateDevices(domain, newVals, friendly, origin)
{
    def mapping =
        [
            ...
            input_datetime: [type: "HADBgeneric Component DateTime",    event: [[name: "dateTime", value: newVals[0], type: origin, descriptionText:"${friendly} datetime was set to ${newVals[0]} [${origin}]"],[name: "date", value: newVals[1], descriptionText:"${friendly} contain a date: ${newVals[1]}"],[name: "time", value: newVals[2], descriptionText:"${friendly} value contains a time ${newVals[2]}"]], namespace: "community"],
