...
def translateSensors(device_class, newVals, friendly, origin)
{
    def mapping =
        [
            ...
            current: [type: "HADB Generic Component Current Meter",           event: [[name: "amperage", value: newVals[0], unit: newVals[1] ?: "A", descriptionText:"${friendly} current is ${newVals[0]} ${newVals[1] ?: 'A'}"]]],
