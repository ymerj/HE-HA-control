...
def translateDevices(domain, newVals, friendly, origin)
{
    def mapping =
        [
            ...
            notify: [type: "HADB Generic Component Notify",             event: [[name: "timestamp", value: newVals[0], descriptionText:"${friendly} event received at ${newVals[0]}"]], namespace: "community"],
