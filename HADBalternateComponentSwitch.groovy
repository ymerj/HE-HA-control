...
metadata
{
    definition(name: "HADB Alternate Component Switch", namespace: "ymerj", author: "Yves Mercier", importUrl: "https://raw.githubusercontent.com/ymerj/HE-HA-control/main/HADBalternateComponentSwitch.groovy")
    {
        capability "Switch"
        capability "Refresh"
        capability "Actuator"
